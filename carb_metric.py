    ...
    def get_metric(self, reset: bool = False):
        if reset:
            ...
            if self._dev_set == 'dev':
                ...
                dev_sents_file = os.path.abspath('data/test/carb_sentences.txt')
            elif self._dev_set == 're_oie16_test':
                dev_sents_file = os.path.abspath('data/re_oie16_test/re_oie16_sentence.txt')
            ...
            if self._dev_set == 'dev':
                ...
                dev_pred_file = os.path.abspath('data/re_oie16_test/re_oie16_extractions.tsv')
